...
class Bills extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _BillsState();
}
...
class _BillsState extends State<Bills> {
  ...
  @override
  void didUpdateWidget(Bills oldWidget) {
  ...
  void setDateFromDb() async {
    ...
    setState(() {
      ...
      accountsModelList =
          fetchedData.where((i) => !i.isDeposit && i.isNotBudget).toList();
      sumTotal();
    });
  }
